    ...
    $('#Button1').click(function () {
        ...
        //$.getJSON("https://viacep.com.br/ws/RS/Porto%20Alegre/all/json/", function (data) {
            $.each(data, function (key, value) {
                ...
                $('#divAlert').append(
                    "<div id=\"divContent\" class=\"alert alert-warning\" role\"alert\"><div class=\"row\">" + "Cidade/Uf: " + value.localidade + "/" + value.uf + "</div><div class=\"row\">" + "Bairro: " + value.bairro + "</div><div class=\"row\">" + "Rua: " + value.logradouro + "</div><div class=\"row\">" + "Cep: " + value.cep + "</div><div class=\"row\">" + "Complemento: " + value.complemento + "</div><div class=\"row\">" + "Dados Ibge: " + value.ibge + "</div><div class=\"row\">" + "Gia: " + value.gia + "</div></a ></div > "
