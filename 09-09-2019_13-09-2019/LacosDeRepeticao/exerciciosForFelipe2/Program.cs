...
namespace exerciciosForFelipe2
{
    class Program
    {
        ...
        /// <summary>
        /// Metodo de busca a palavra função while
        /// </summary>
        /// <param name="wordFind">Palavra com 3 caracteres</param>
        /// <returns>retorna a qtd encontrada do texto</returns>
        ...
        /// </summary>
        /// <returns>O conteudo do testo em string</returns>
